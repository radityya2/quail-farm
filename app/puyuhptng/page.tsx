      ...
      <div className="flex justify-center w-full">
        <div className="flex max-w-4xl w-full">
          <div className="flex-shrink-0 bg-white rounded-lg p-4 mr-4">
            <Image
              src="/puyuhptng.png" // Ganti dengan path gambar yang sesuai
              alt="Puyuh Potong"
              width={350}
              height={350}
          ...
          <div className="ml-6 flex-grow">
            <h1 className="text-[#EDC043] text-3xl font-bold text-left mb-8" style={{ fontFamily: 'Milker, sans-serif' }}>PUYUH POTONG</h1>
